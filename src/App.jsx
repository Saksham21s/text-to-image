      ...
      <nav className="bg-transparent ">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a className='text-white' href="#" target='_blank' rel="noreferrer">
            ...
            <span className="self-center text-sm font-semibold whitespace-nowrap">Made with 💓 by Saksham Pandey</span>
          </a>
          <a href='https://github.com/Saksham21s/text-to-image' target='_blank' rel="noreferrer" className='bg-gray-100 p-2 rounded text-black flex justify-center items-center gap-1'> <span className='text-lg'><FaGithub /></span> Source code</a>
        </div>
      </nav>
